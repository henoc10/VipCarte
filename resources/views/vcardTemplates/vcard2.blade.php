                            ...
                            <div class="row">
                                <div class="col-sm-12 justify-content-between social-link-modal">
                                    <a href="http://www.facebook.com/sharer.php?u={{ $shareUrl }}"
                                        ...
                                        <i class="fab fa-facebook fa-2x mb-4 " style="color: #1B95E0"></i>
                                    </a>
                                    <a href="http://twitter.com/share?url={{ $shareUrl }}&text={{ $vcard->name }}&hashtags=sharebuttons"
                                        target="_blank" class="mx-2 share2" title="Twitter">
                                        <i class="fab fa-twitter fa-2x mb-4 " style="color: #1DA1F3"></i>
                                    </a>
                                    <a href="http://www.linkedin.com/shareArticle?mini=true&url={{ $shareUrl }}"
                                        target="_blank" class="mx-2share2" title="Linkedin">
                                        <i class="fab fa-linkedin fa-2x  mb-4 " style="color: #1B95E0"></i>
                                    </a>
                                    <a href="mailto:?Subject=&Body={{ $shareUrl }}" target="_blank"
                                        class="mx-2 share2" title="Email">
                                        <i class="fas fa-envelope fa-2x mb-4 " style="color: #191a19  "></i>
                                    </a>
                                    <a href="http://pinterest.com/pin/create/link/?url={{ $shareUrl }}"
                                        target="_blank" class="mx-2 share2" title="Pinterest">
                                        <i class="fab fa-pinterest fa-2x mb-4 " style="color: #bd081c"></i>
                                    </a>
                                    <a href="http://reddit.com/submit?url={{ $shareUrl }}&title={{ $vcard->name }}"
                                        target="_blank" class="mx-2 share2" title="Reddit">
                                        <i class="fab fa-reddit fa-2x  mb-4" style="color: #ff4500"></i>
                                    </a>
                                    <a href="https://wa.me/?text={{ $shareUrl }}" target="_blank"
                                        class="mx-2 share2" title="Whatsapp">
                                        <i class="fab fa-whatsapp fa-2x mb-4 " style="color: limegreen"></i>
                                    </a>
                                    ...
                                    <button class="mx-2  copy-vcard-clipboard" title="Copy Link"
                                        data-id="{{ $vcard->id }}">
                                        <i class="fa-regular fa-copy fa-2x mb-4" style="color: #0099fb"></i>
                                    </button>
                                </div>
                            </div>
                            <div class="text-center">
