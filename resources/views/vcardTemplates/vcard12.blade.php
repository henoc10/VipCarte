                    ...
                    <div class="contact-form pt-3 mt-3 position-relative">
                        <form action="" id="enquiryForm">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        <label class="text-white mb-1">{{ __('messages.form.your_name') }}</label>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        <label class="text-white mb-1">{{ __('messages.user.your_message') }}</label>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12 justify-content-between social-link-modal">
                            ...
                            <a class="mx-2 copy-vcard-clipboard" title="Copy Link" data-id="{{ $vcard->id }}">
