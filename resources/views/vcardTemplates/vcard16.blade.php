                                ...
                                <div class="col-12 mb-10">
                                    <div class="contact-box d-flex align-items-center">
                                        ...
                                        <div class="contact-desc">
                                            ...
                                            {{ $vcard->phone }}"
                                                class="text-primary fw-6 mb-0 fs-14">+{{ $vcard->region_code }} {{ $vcard->phone }}</a>
                                        </div>
                                    </div>
                                </div>
                            @endif
                                        ...
                                        <div class="gallery-images">
                                            ...
                                            @elseif($file->type == App\Models\Gallery::TYPE_AUDIO)
                                                <div class="audio-container">
                                                    <img src="{{ asset('assets/img/music.jpeg') }}" alt="Album Cover" class="audio-image" height="135">
            ...
            @if (checkFeature('products') && $vcard->products->count())
                <div class="product-section pt-40 pb-30">
                    <div class="section-heading left-heading ">
                        ...
                        <a class="fs-6 mb-0 text-decoration-underline p-2" href="{{ route('showProducts',['id'=>$vcard->id,'alias'=>$vcard->url_alias]) }}">{{__('messages.analytics.view_more')}}</a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 justify-content-between social-link-modal">
                            <a href="http://www.facebook.com/sharer.php?u={{ $shareUrl }}" target="_blank"
                                class="mx-2 share10" title="Facebook">
                            ...
                            <a href="http://pinterest.com/pin/create/link/?url={{ $shareUrl }}" target="_blank"
                                class="mx-2 share10" title="Pinterest">
                            ...
                            <a href="https://wa.me/?text={{ $shareUrl }}" target="_blank" class="mx-2 share10"
                                title="Whatsapp">
